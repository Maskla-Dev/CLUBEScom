    ...
    public partial class Model : Migration
    {
        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_CalendarTypes", x => x.ID);
                });
            ...
            migrationBuilder.CreateTable(
                ...
                {
                    ID = table.Column<Guid>(type: "TEXT", nullable: false),
                    PresidentId = table.Column<string>(type: "TEXT", nullable: true),
                    OptionalPhoneNumber = table.Column<string>(type: "TEXT", nullable: false),
                    OptionalEmail = table.Column<string>(type: "TEXT", nullable: false),
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_Calendars_CalendarTypes_typeID",
                        column: x => x.typeID,
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_PostCalendarlinks", x => x.ID);
                    table.ForeignKey(
                        name: "FK_PostCalendarlinks_Calendars_CalendarID",
                        column: x => x.CalendarID,
                        principalTable: "Calendars",
                        principalColumn: "ID",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_PostCalendarlinks_Posts_PostID",
                        column: x => x.PostID,
            ...
            migrationBuilder.CreateIndex(
                name: "IX_PostCalendarlinks_CalendarID",
                table: "PostCalendarlinks",
                column: "CalendarID");

            migrationBuilder.CreateIndex(
                name: "IX_PostCalendarlinks_PostID",
                table: "PostCalendarlinks",
                column: "PostID");
